...
bne	$t1, 0, reassignA1	# if $t1 isn't equal to 0, then a1 is smaller than t0, so we need to reassign t0
...
bne 	$t1, 0, reassignA2	# if $t1 isn't equal to 0, then a2 is smaller than t0, so we need to reassign t0
